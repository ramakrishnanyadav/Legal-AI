// src/components/ActionPlanCard.tsx - Personalized Action Plan Display - FIXED
...
interface ActionPlan {
  ...
  costEstimate: {
    ...
    note?: string; // ✅ FIXED: Made note optional
  };
            ...
            >
              <div className="p-6 space-y-6">
                ...
                <div className="pt-6 border-t border-white/10">
                  ...
                  {/* Risks */}
                  <div className="mb-4">
                    <p className="text-sm font-semibold text-yellow-400 mb-2">⚠️ Risks</p>
                    <ul className="space-y-2">

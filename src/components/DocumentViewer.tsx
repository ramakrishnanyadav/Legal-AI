...
interface GeneratedDocuments {
  firDraft: {
    english: string;
    hindi: string;
    marathi?: string; // ✨ NEW: Marathi language support
...
const DocumentViewer = ({ documents }: DocumentViewerProps) => {
  ...
  // Γ£à Safe helpers to handle data inconsistencies
              ...
              <div className="p-6">
                ...
                <div className="mb-4 p-8 rounded-xl bg-white text-black max-h-[600px] overflow-y-auto print:shadow-none" id="fir-template">
                  {language === 'english' ? (
                    ...
                    <div className="space-y-4 text-sm">
                      <div className="text-center border-b-2 border-black pb-3">
                        <h2 className="text-xl font-bold">αñ¬αÑìαñ░αñÑαñ« αñ╕αÑéαñÜαñ¿αñ╛ αñ░αñ┐αñ¬αÑïαñ░αÑìαñƒ</h2>
                        <p className="text-xs">(αñºαñ╛αñ░αñ╛ 154 αñ╕αÑÇ.αñåαñ░.αñ¬αÑÇ.αñ╕αÑÇ. αñòαÑç αñàαñéαññαñ░αÑìαñùαññ)</p>
                      </div>

                      <div className="grid grid-cols-2 gap-3">
                        <p><strong>αñÅαñ½.αñåαñê.αñåαñ░. αñ╕αñéαñûαÑìαñ»αñ╛:</strong> __________________</p>
                        <p><strong>αñªαñ┐αñ¿αñ╛αñéαñò:</strong> __________________</p>
                      </div>

                      <div className="border border-black p-3">
                        <p className="font-bold mb-2">αñ¬αÑüαñ▓αñ┐αñ╕ αñ╕αÑìαñƒαÑçαñ╢αñ¿ αñ╡αñ┐αñ╡αñ░αñú</p>
                        <p><strong>αñÑαñ╛αñ¿αñ╛:</strong> _________________________________</p>
                        <p><strong>αñ£αñ┐αñ▓αñ╛:</strong> ________________________________________</p>
                        <p><strong>αñ░αñ╛αñ£αÑìαñ»:</strong> __________________________________________</p>
                      </div>

                      <div className="border border-black p-3">
                        <p className="font-bold mb-2">αñ╢αñ┐αñòαñ╛αñ»αññαñòαñ░αÑìαññαñ╛ αñòαÑÇ αñ£αñ╛αñ¿αñòαñ╛αñ░αÑÇ</p>
                        <p><strong>αñ¿αñ╛αñ«:</strong> ___________________________________________</p>
                        <p><strong>αñ¬αñ┐αññαñ╛/αñ¬αññαñ┐ αñòαñ╛ αñ¿αñ╛αñ«:</strong> ________________________</p>
                        <p><strong>αñåαñ»αÑü:</strong> ____________________________________________</p>
                        <p><strong>αñ¬αññαñ╛:</strong> _________________________________________</p>
                        <p className="pl-4">_____________________________________________________</p>
                        <p><strong>αñ«αÑïαñ¼αñ╛αñçαñ▓:</strong> __________________________________________</p>
                        <p><strong>αñêαñ«αÑçαñ▓:</strong> ___________________________________________</p>
                      </div>

                      <div className="border border-black p-3">
                        <p className="font-bold mb-2">αñÿαñƒαñ¿αñ╛ αñ╡αñ┐αñ╡αñ░αñú</p>
                        <p><strong>αñÿαñƒαñ¿αñ╛ αñòαÑÇ αññαñ╛αñ░αÑÇαñû:</strong> ______________________________</p>
                        <p><strong>αñ╕αñ«αñ»:</strong> ____________________________________________</p>
                        <p><strong>αñ╕αÑìαñÑαñ╛αñ¿:</strong> ___________________________________________</p>
                        <p className="pl-4">_____________________________________________________</p>
                      </div>

                      <div className="border border-black p-3">
                        <p className="font-bold mb-2">αñÿαñƒαñ¿αñ╛ αñòαñ╛ αñ╡αñ┐αñ╡αñ░αñú</p>
                        <div className="min-h-[150px] border border-gray-400 p-2">
                          {Array(6).fill('_').map((_, i) => (
                            <p key={i}>_________________________________________________________</p>
                          ))}
                      ...
                      <div className="border border-black p-3">
                        <p className="font-bold mb-2">αñ▓αñ╛αñùαÑé αñºαñ╛αñ░αñ╛αñÅαñé (αñ¬αÑüαñ▓αñ┐αñ╕ αñªαÑìαñ╡αñ╛αñ░αñ╛)</p>
                        <p><strong>αñåαñê.αñ¬αÑÇ.αñ╕αÑÇ. αñºαñ╛αñ░αñ╛αñÅαñé:</strong> {safeSectionsApplied.join(', ') || '____________________________'}</p>
                      </div>

                      <div className="grid grid-cols-2 gap-8 mt-6">
                        <div>
                          <p className="mb-8">_______________________</p>
                          <p className="font-bold text-xs">αñ╢αñ┐αñòαñ╛αñ»αññαñòαñ░αÑìαññαñ╛ αñòαÑç αñ╣αñ╕αÑìαññαñ╛αñòαÑìαñ╖αñ░</p>
                        </div>
                        <div>
                          <p className="mb-8">_______________________</p>
                          <p className="font-bold text-xs">αñ¬αÑüαñ▓αñ┐αñ╕ αñàαñºαñ┐αñòαñ╛αñ░αÑÇ αñòαÑç αñ╣αñ╕αÑìαññαñ╛αñòαÑìαñ╖αñ░</p>
                        </div>
                      </div>
                    </div>
                  )}
